...
class Marshall : AppCompatActivity(), View.OnClickListener {

    val weaponUuid : String = "c4883e50-4494-202c-3ec3-6b8a9284f00b"

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_marshall)
    ...
    override fun onClick(v: View) {
        when (v.id) {
            R.id.side_nav -> {
                ...
                val rootView: ViewGroup = findViewById(R.id.marshall_layout)
                ...
                mFragmentManager
                    .beginTransaction()
                    .add(
                        R.id.marshall_layout, mSideNavFragment,
